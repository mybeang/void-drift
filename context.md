...
- **이슈**: [issues.md](Docs/Dev/issues.md) — **열림 I-5**(라인 통과 오브젝트 페이드아웃 — 오브만 알파 페이드 구현됨, 시작선/완만함 튜닝은 나중 파킹). **해결 I-1·I-2·I-3·I-4·I-6**(I-6=돌진 접촉 퇴장 VFX + 자폭 상태머신[멈춤·빨간깜박·폭발 VFX·범위 감쇠 데미지], 2026-08-22).
